 ...
 *
 */
public class WorkOrderDelayRunner implements Runnable  {
	...
	private static final Logger LOG = Logger.getLogger(WorkOrderDelayRunner.class);

	private String  chargingPileNum;
	private IndexValueVO indexValueVO;
	

	public WorkOrderDelayRunner() {
		super();
	}

	public WorkOrderDelayRunner(String chargingPileNum, IndexValueVO indexValueVO) {
		super();
...
//		LOG.info(String.format("桩【%s】故障【%s】发生超过25s-----------望天，这个桩坏了，快来修啊 ", chargingPileNum,indexValueVO.getIndexNum()));
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WorkOrderDelayRunner other = (WorkOrderDelayRunner) obj;
