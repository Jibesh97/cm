...
! function(t, o, s, e) {
	...
	function a(s) {
		...
		switch(l.settings.position) {
			case "top":
				r = d.offset().left + d.outerWidth() / 2 - a.outerWidth() / 2, e = d.offset().top - n(a) - p+25, a.find(".tipso_arrow").css({
					marginLeft: -8
	...
	t.extend(r.prototype, {
		...
		tooltip: function() {
			return this.tipso_bubble || (this.tipso_bubble = t('<div class="tipso_bubble" style="position: absolute;text-align: center;border-radius: 4px;z-index: 9999;padding: 3px 8px;width: auto;min-width:200px"><div class="tipso_content"></div><div class="tipso_arrow"></div></div>')), this.tipso_bubble
		},
		show: function() {
			var s = this.tooltip(),
				e = this,
